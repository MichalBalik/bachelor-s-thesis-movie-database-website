...
if($jwt){
    try {
        ...
        if($decoded->data->funkcia =="admin" &&$film->delete()){


            http_response_code(200);
            echo json_encode(array("message" => "Delete prebehol uspesne"));
        }
    ...
    echo json_encode(array("message" => "VYMAZANIE  PREBEHLO NEUSPESNE"));
}
?>